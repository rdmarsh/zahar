...
expandData = [click.option("--expandData", "expandData", multiple=True, metavar="PROPERTY", help="Return the name of the host that the application belongs to as a property of the application object.")]
