...
groupids = [click.option("--groupid", "groupids", type=int, multiple=True, metavar="ID", help="Return objects that use the given group ID.")]
hostids = [click.option("--hostid", "hostids", type=int, multiple=True, metavar="ID", help="Return objects that use the given host ID.")]
triggerids = [click.option("--triggerid", "triggerids", type=int, multiple=True, metavar="ID", help="Return objects that use the given trigger ID.")]
mediatypeids = [click.option("--mediatypeid", "mediatypeids", type=int, multiple=True, metavar="ID", help="Return objects that use the given mediatype ID.")]
usrgrpids = [click.option("--usrgrpid", "usrgrpids", type=int, multiple=True, metavar="ID", help="Return objects that send messages to the given user group ID.")]
...
selectFilter = [click.option("--selectFilter", "selectFilter", multiple=True, metavar="PROPERTY", help="Returns a filter property.")]
...
inheritedTags = [click.option("--inheritedTags", "inheritedTags", is_flag=True, help="Return objects that have been inherited.")]
...
withProblemsSuppressed = [click.option("--withProblemsSuppressed", "withProblemsSuppressed", is_flag=True, help="Return only objects with inventory data.")]
...
selectMessageTemplates = [click.option("--selectMessageTemplates", "selectMessageTemplates", multiple=True, metavar="PROPERTY", help="Returns the action filter in the filter property.")]
selectInheritedTags = [click.option("--selectInheritedTags", "selectInheritedTags", multiple=True, metavar="PROPERTY", help="Returns the action filter in the filter property.")]
selectDetails = [click.option("--selectDetails", "selectDetails", multiple=True, metavar="PROPERTY", help="Returns the Details filter in the filter property.")]
...
auditids = [click.option("--auditid", "auditids", type=int, multiple=True, metavar="ID", help="Return objects with the given audit id.")]
...
with_historical_items = [click.option("--with_historical_items", "with_historical_items", help="History object types to return.")]
...
filter = [click.option("--filter", "-f", "filter", nargs=2, multiple=True, metavar="KEY VALUE", help="Return only results that exactly match the filter.")]
...
search = [click.option("--search", "-s", "search", nargs=2, multiple=True, help="Return results that match wildcard search (case-insensitive).")]
